...
function gerarCubo(n) {
  ...
  return cube; // Retorna o cubo criado para possível uso posterior
}

// Usando async/await
async function executarLoop() {
  for (let n = 0; n < total; n++) {
    const cube = gerarCubo(n); // Gera um cubo com o número atual do loop
    grid.appendChild(cube); // Adiciona o cubo ao elemento grid

    // Espera 500ms antes da próxima iteração
